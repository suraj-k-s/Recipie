...
if(isset($_GET["id"]))
{
    $delQry = "delete from tbl_user where user_id='".$_GET["id"]."'";
...
<html lang="en" >
    ...
    <body>
        <h1 align="center" id="heading">Users</h1>
        <br><br>
 ...
 while($data=$row->fetch_assoc())
 {
     ...
     ?>
         <tr>
             ...
             <td align="center"><?php echo $data["user_place"]; ?></td>
             <td align="center"><?php echo $data["user_email"]; ?></td>
             <td align="center">
                 <a href="Users.php?id=<?php echo $data["user_id"]; ?>">Delete</a>
             </td>
         </tr>
     <?php
 }?>
